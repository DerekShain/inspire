export class Weather {
    ...
    <div onclick="app.weatherController.tempChange()" class="p3">
      <h2 style="text-align: center;"> ${this.name}<img src="http://openweathermap.org/img/wn/${this.wxIcon()}@2x.png">
        <span id="tChange">${this.fahrenheit} F
        </span>
      </h2>
    </div><br/>
        <h6 style="text-align: center;">Sky Conditions: ${this.formatWeather()}</h6>
        <h6 style="text-align: center;">Coordinates:  ${this.lat} Latitude, ${this.long} Longitude</h6>
        <h6 style="text-align: center;">Wind Speed: ${this.wind}</h6>
        <h6 style="text-align: center;">Wind Direction: ${this.windD}</h6>
        <h6 style="text-align: center;">Pressure: ${this.pressure} inHg </h6>
        <h6 style="text-align: center;">Humidity: ${this.humidity} %</h6>
        `;
    }
