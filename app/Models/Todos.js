...
export class Todos{
    ...
    get Template(){
     ...
     ${this.completed ? 'checked' : ''} onclick="app.todosController.toggleDone('${this.id}')" >
      <label for="checkbox"> 
   
      ${this.description} 
      <i class="fas fa-trash-alt trashPosition" onclick="app.todosController.deleteTodo('${this.id}')"></i>
